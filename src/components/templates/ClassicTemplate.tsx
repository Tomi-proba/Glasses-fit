          ...
          {experience.map((exp) => (
            <div key={exp.id} className="mb-5">
              <div className="flex items-baseline justify-between">
                ...
                <span className="text-xs italic text-neutral-600">{formatRange(exp.start, exp.end, exp.current)}</span>
              </div>
          ...
          {education.map((edu) => (
            <div key={edu.id} className="mb-3">
              <div className="flex items-baseline justify-between">
                ...
                <span className="text-xs italic text-neutral-600">{formatRange(edu.start, edu.end)}</span>
              </div>
